...
つまり[`jis2ucs.yml`](https://github.com/aozorahack/aozora2html/blob/master/yml/jis2ucs.yml)をバイナリ形式にしたものです。
...
| jis2ucs.bin | 23,844 | バイナリ形式 |
| jis2ucs.bin.gz | 23,120 | 圧縮後/実際は使用せず |
