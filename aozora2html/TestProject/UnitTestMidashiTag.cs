...
public static class UnitTestMidashiTag
{
    ...
    public static void TestToHtml()
    {
        ...
        Assert.Equal("<h5 class=\"ko-midashi\"><a class=\"midashi_anchor\" id=\"midashi2\">テスト見出し</a></h5>", tag.to_html());
    }
    ...
    public static void TestToHtmlMado()
    {
        ...
        Assert.Equal("<h5 class=\"mado-ko-midashi\"><a class=\"midashi_anchor\" id=\"midashi2\">テスト見出し</a></h5>", tag.to_html());
    }
