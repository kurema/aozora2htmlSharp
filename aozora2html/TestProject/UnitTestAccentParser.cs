...
public static class UnitTestAccentParser
{
    ...
    public static void TestNew()
    {
        ...
        var parsed = new Aozora.Helpers.AccentParser(stream, '〕', new(), new(), output, gaiji_dir: "g_dir/").processAccent().to_html();
    ...
    public static void TestInvalid()
    {
        ...
        var parsed = new Aozora.Helpers.AccentParser(stream, '〕', new(), new(), output, warnChannel: warn, gaiji_dir: "g_dir/").processAccent().to_html();
        //kurema:元のテストでは行末は"\n"でしたが、こちらでは"\r\n"にしています。
    ...
    public static void TestUseJisx0213()
    {
        ...
        var stream = new Aozora.Jstream(sr);
        var output = new Aozora.Helpers.OutputString();
        var parsed = new Aozora.Helpers.AccentParser(stream, '〕', new(), new(), output, gaiji_dir: "g_dir/") { use_jisx0213_accent = true }.processAccent().to_html();
