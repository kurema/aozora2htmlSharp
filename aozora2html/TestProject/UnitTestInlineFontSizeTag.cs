...
public static class UnitTestInlineFontSizeTag
{
    ...
    public static void TestToHtml1()
    {
        ...
        Assert.Equal("<span class=\"dai1\" style=\"font-size: large;\">テスト</span>", tag.to_html());
    }
    ...
    public static void TestToHtml2()
    {
        ...
        Assert.Equal("<span class=\"sho2\" style=\"font-size: x-small;\">テスト</span>", tag.to_html());
    }
    ...
    public static void TestToHtml3()
    {
        ...
        Assert.Equal("<span class=\"sho3\" style=\"font-size: xx-small;\">テスト</span>", tag.to_html());
    }
}
