...
public static class UnitTestTagParser
{
    ...
    public static void TestParseKatakana()
    {
        ...
        var (command, _) = new TagParser(stream, '！', new(), new(), new OutputDummy()).process();
    ...
    public static void TestParseGaijiA()
    {
        ...
        var stream = new Jstream(sr);
        var (command, _) = new TagParser(stream, '…', new(), new(), new OutputDummy(), gaiji_dir: "g_dir/").process();
    ...
    public static void TestParseGaijiJisx0213()
    {
        ...
        var stream = new Jstream(sr);
        var (command, _) = new TagParser(stream, '…', new(), new(), new OutputDummy(), gaiji_dir: "g_dir/") { use_jisx0214_embed_gaiji = true }.process();
