...
public static class Utils
{
	...
	{
		jis_gaiji, chuki, onebyte, legal, non_jis
	}
	...
	public static IllegalCharCheckResult IllegalCharCheck(char @char, int line, IOutput output)
	{
		...
		switch (result)
		{
			...
			case IllegalCharCheckResult.onebyte:
				...
				break;
			case IllegalCharCheckResult.non_jis:
				output.PrintLine(string.Format(Resources.Resource.WarnNonJis, line, @char));
				break;
	...
	public static IllegalCharCheckResult IllegalCharCheck(char @char)
	{
		...
		if (code.EncodeExceptionThrown)
		{
			return IllegalCharCheckResult.non_jis;
		}
		if ((codeUshort == 0x21) ||
			(codeUshort == 0x23) ||
